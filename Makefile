...
continuous:
	CXX=g++ CXXFLAGS='-std=c++11 -g -Wall' LIBS='-lz -pthread -lpcrecpp -lcrypto' ekam -j6 -c -n :41315

continuous-clang:
	CXX=clang++ CXXFLAGS='-fno-caret-diagnostics -std=c++11 -g -Wall' LIBS='-lz -pthread -lpcrecpp -lcrypto' ekam -j6 -c -n :41315
